...
{
    public partial class AssetBundleBuildPanel : EditorWindow
    {
        [MenuItem("Tool/ABSystem/Builder Panel")]
        static void Open()
        {
            GetWindow<AssetBundleBuildPanel>("ABSystem", true);
        }

        [MenuItem("Tool/ABSystem/1_Build AssetBundles")]
        static void BuildAssetBundles()
        {
			...
			ABBuilder builder = new AssetBundleBuilder5x(/*new PathResolver()*/);
#else
            //弃用4.x以下版本
			ABBuilder builder = new AssetBundleBuilder4x(new PathResolver());
#endif
        ...
        public static readonly string savePath = "Assets/Scripts/ABSystem/config.asset";
        ...
        void OnGUI()
        {
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    EditorGUILayout.PrefixLabel("Asset Vision");
                    _config.version = (uint)EditorGUILayout.IntField((int)_config.version);
                }
                GUILayout.EndHorizontal();
