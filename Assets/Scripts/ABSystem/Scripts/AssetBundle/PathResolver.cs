...
namespace game.Assets
{
    ...
    public static class PathResolver
    {
        ...
        /// AB 保存的文件夹路径
        /// </summary>
        public static string BundleSaveDirName { get { return Application.productName/*"AssetBundles"*/; } }
        /// <summary>
        /// AB 保存的路径
        /// </summary>
        ...
        /// 外部资源常驻根路径
        /// </summary>
        public static readonly string PATH = Platform.PERSISTENT_DATA_PATH + "/" + BundleSaveDirName + "/" + GetPlatformName();

        /// <summary>
        /// 包内资源
        /// </summary>
        public static readonly string INITIAL_PATH = Platform.STREAMING_ASSETS_PATH + "/" + BundleSaveDirName + "/" + GetPlatformName();
